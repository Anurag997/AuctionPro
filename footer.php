                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="about-us-footer">
                                    <div class="footer-logo">
                                        <a href="#"><img src="img/logo.png" style="width: 150px;height: 150px;" ></a>
                                    </div>
                                    <div class="footer-info">
                                        <p class="phone">+91-8795997997</p>
                                    </div>
                                </div>
                            </div>
...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> IT Crowd<br>SRMIST. KTR</p>
                                                <p>Call us: <span>+918795997997 </span></p>
                                                <p>Email us: <span>contact@auctionpro.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; AuctionPro. All Rights Reserved</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
